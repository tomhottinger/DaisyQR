<?php
/**
 * API: Shared URL bestaetigt auf bereits programmierten Code schreiben
 */
...
if (!programCode($codeId, $sharedUrl, $sharedTitle ?: null, $currentUserId)) {
    ...
    echo json_encode([
        ...
        'message' => 'Code konnte nicht ueberschrieben werden.'
    ]);
    exit;
}
...
echo json_encode([
    'action' => 'SHARE_OVERWRITTEN',
    'message' => 'Code wurde mit der geteilten URL ueberschrieben.',
    'code_id' => $codeId,
    'code_url' => $sharedUrl
]);
